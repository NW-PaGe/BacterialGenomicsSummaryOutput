...
if (params$phylogeny == "Snippy") {
  partition_info_filtered <- partition_info %>%
    ...
    rename(
      ...
      ISO_IN_PARTITION = PARTITION_Snippy_Counts
    )
  ...
  partition_info_filtered <- partition_info %>%
    ...
    rename(
      ...
      ISO_IN_PARTITION = PARTITION_Gubbins_Counts
    )
  ...
  partition_info_filtered <- partition_info %>%
    ...
    rename(
      ISO_IN_PARTITION_Snippy = PARTITION_Snippy_Counts,
      ISO_IN_PARTITION_Gubbins = PARTITION_Gubbins_Counts
    )
} else {
  stop("Invalid phylogeny parameter. Choose 'Snippy', 'Gubbins', or 'all'.")
}
