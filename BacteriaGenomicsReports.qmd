...
In this BigBacter run, there are `r nrow(newseq)` new sequencing results from patients who reside in   **`r tools::toTitleCase(params$PatientAddressCounty)`** county or counties.
