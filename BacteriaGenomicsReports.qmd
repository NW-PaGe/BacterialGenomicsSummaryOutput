...
params:
  taxa: "Placeholder"
  phylogeny: "all" #defaults to showing both Snippy and Gubbins results but the renderind script will override this if Gubbins or Snippy are selected
---
...
The new isolates were analyzed using **`r tools::toTitleCase(params$phylogeny)`** and classified by BigBacter as follows:
...
summary_new_seq <- summary_new_seq %>%
